...
return new class extends Migration
{
    ...
    {
        Schema::create('rates_transfers', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('rate_group_id')->nullable();
            $table->unsignedBigInteger('destination_service_id')->nullable();
            $table->unsignedBigInteger('destination_id')->nullable();
            $table->unsignedBigInteger('zone_one')->nullable();
            $table->unsignedBigInteger('zone_two')->nullable();
            ...
            $table->index('zone_one');
            $table->index('zone_two');
    ...
    {
        Schema::dropIfExists('rates_transfers');
    }
};
