@if( $data['lang'] == "en")
    ...
    <p>In all our services, our units have the facility to wait for the client for a period not exceeding 30 minutes at the indicated location on their Ticket. After this waiting time, the unit will withdraw, leaving no right to any refund. Reporting the service as "No show".</p>
...
@if( $data['lang'] == "es")
    ...
    <p>En todos nuestros servicios, nuestras unidades tienen la facilidad de esperar al cliente por un per&iacute;odo que no exceda los 30 minutos en el lugar indicado en su boleto. Despu&eacute;s de este tiempo de espera, la unidad se retirar&aacute;, sin derecho a reembolso alguno.</p>
